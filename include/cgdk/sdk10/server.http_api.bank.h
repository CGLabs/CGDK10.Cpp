...
// 2) Definitions
#include "cgdk/sdk10/server.http_api/bank/server.http_api.bank.definitions.h"
#include "cgdk/sdk10/server.http_api/bank/server.http_api.bank.definitions.struct.h"

// 3) APIs
#include "cgdk/sdk10/server.http_api/bank/server.http_api.bank.api.h"
...
//----------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------
		...
		// WinSDK 10
			...
			#ifdef NDEBUG
				#pragma message("[CGDK10] 'CGDK10.server.http_api.bank_Windows10.0_x64_Release.lib' will be linked")
				#pragma comment(lib, "cgdk/sdk10/CGDK10.server.http_api.bank_Windows10.0_x64_Release.lib")
			#else
				#pragma message("[CGDK10] 'CGDK10.server.http_api.bank_Windows10.0_x64_Debug.lib' will be linked")
				#pragma comment(lib, "cgdk/sdk10/CGDK10.server.http_api.bank_Windows10.0_x64_Debug.lib")
			#endif
		// Error - No supported
		#else
