...
//----------------------------------------------------------------------------
// 1) 
#define	CGDK_SERVER_OAUTH_NAVER
...
// 2) Definitions
#include "cgdk/sdk10/server.http_api/naver/server.http_api.naver.definitions.h"
#include "cgdk/sdk10/server.http_api/naver/server.http_api.naver.definitions.struct.h"

// 3) APIs
#include "cgdk/sdk10/server.http_api/naver/server.http_api.naver.api.h"
...
//----------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------
		...
		// WinSDK 10
			...
			#ifdef NDEBUG
				#pragma message("[CGDK10] 'CGDK10.server.http_api.naver_Windows10.0_x64_Release.lib' will be linked")
				#pragma comment(lib, "cgdk/sdk10/CGDK10.server.http_api.naver_Windows10.0_x64_Release.lib")
			#else
				#pragma message("[CGDK10] 'CGDK10.server.http_api.naver_Windows10.0_x64_Debug.lib' will be linked")
				#pragma comment(lib, "cgdk/sdk10/CGDK10.server.http_api.naver_Windows10.0_x64_Debug.lib")
			#endif
		// Error - No supported
		#else
