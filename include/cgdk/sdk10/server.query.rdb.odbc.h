...
//----------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------
		...
		// WinSDK 10
				...
				#pragma comment(lib, "cgdk/sdk10/windows/CGDK10.server.query.rdb.odbc_Windows10.0_x64_Release.lib")
			#else
				#pragma message("[CGDK10] 'CGDK10.server.query.rdb.odbc_Windows10.0_x64_Debug.lib' will be linked")
				#pragma comment(lib, "cgdk/sdk10/windows/CGDK10.server.query.rdb.odbc_Windows10.0_x64_Debug.lib")
			#endif
		// Error - No supported
		#else
