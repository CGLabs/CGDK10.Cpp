...
//----------------------------------------------------------------------------
// 1) 
#define	CGDK_SERVER_OAUTH_KAKAO
...
// head File
// ----------------------------------------------------------------------------
// 1) CGDK base include files
#include "cgdk/sdk10/server.query.http.h"

// 2) Definitions
#include "cgdk/sdk10/server.http_api/kakao/server.http_api.kakao.definitions.h"
#include "cgdk/sdk10/server.http_api/kakao/server.http_api.kakao.definitions.struct.h"

// 3) APIs
#include "cgdk/sdk10/server.http_api/kakao/server.http_api.kakao.api.h"
...
//----------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------
		...
		// WinSDK 10
			...
			#ifdef NDEBUG
				#pragma message("[CGDK10] 'CGDK10.server.http_api.kakao_Windows10.0_x64_Release.lib' will be linked")
				#pragma comment(lib, "cgdk/sdk10/CGDK10.server.http_api.kakao_Windows10.0_x64_Release.lib")
			#else
				#pragma message("[CGDK10] 'CGDK10.server.http_api.kakao_Windows10.0_x64_Debug.lib' will be linked")
				#pragma comment(lib, "cgdk/sdk10/CGDK10.server.http_api.kakao_Windows10.0_x64_Debug.lib")
			#endif
		// Error - No supported
		#else
