...
namespace CGDK::http_api::apple
{
	...
	//RESPONSE_LOGOUT request(const REQUEST_LOGOUT& _request);
	//RESPONSE_SIGNUP request(const REQUEST_SIGNUP& _request);
	//RESPONSE_UNLINK request(const REQUEST_UNLINK& _request);
	//RESPONSE_ME request(const REQUEST_ME& _request);
	//RESPONSE_UPDATE_PROFILE request(const REQUEST_UPDATE_PROFILE& _request);
	//RESPONSE_IDS request(const REQUEST_IDS& _request);
	//RESPONSE_ACCESS_TOKEN_INFO request(const REQUEST_ACCESS_TOKEN_INFO& _request);
