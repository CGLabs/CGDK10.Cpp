...
2. CGCII Server DB Query Classes의 주요 클래스 및 구성 요소들
   ...
   1) Querier
      - query::DB::querier
      - query::DB::CrequestorConcurrent
      - query::DB::CrequestorConcurrentLambda
      - query::DB::CrequestorConcurrentWait

   2) Query
      - query::DB::Iquery<T>
      - query::DB::CQueryStatic<T>
