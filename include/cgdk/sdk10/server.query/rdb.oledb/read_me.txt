...
1. CGCII Server Query DB Classes
...
2. CGCII Server oledb Query Classes의 주요 클래스 및 구성 요소들
   ...
   CGCII oledb Query Class는 크게 Querier와 Query로 나눌 수 있다.
   ...
   1) Querier
      - query:oledb::querier
      - query:oledb::CrequestorConcurrent
      - query:oledb::CrequestorConcurrentLambda
      - query:oledb::CrequestorConcurrentWait

   2) Query
      - query::oledb::Iquery<T>
      - query::oledb::CQueryStatic<T>
