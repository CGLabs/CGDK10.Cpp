...
//
//
// 2. CG3DRenderer의 핵심! Function의 기능 설명
...
// ----------------------------------------------------------------------------
public:
			void				ResetLocalTransformMatrix()				{	SetLocalTransformMatrix(nullptr);}
	virtual	void				SetLocalTransformMatrix(CMatrix* p_ptmWorld) PURE;
	virtual	CGPTR<CMatrix>		GetLocalTransformMatrix() PURE;
};
