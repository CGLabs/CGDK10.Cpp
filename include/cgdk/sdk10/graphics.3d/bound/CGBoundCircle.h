...
public:
	...
	// 3) Attributes
			void				CG3DBoundInfo();
			void				SetBoundingInfo(const CIRCLE& p_rCircle);
			const CIRCLE&		GetBounding() const						{	return m_Bounding;}
			const CIRCLE&		GetOriginalBounding() const				{	return m_Bounding_Original;}
