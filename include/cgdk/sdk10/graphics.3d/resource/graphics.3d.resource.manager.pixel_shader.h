...
//
//-----------------------------------------------------------------------------
class  CGResource::CPixelshader::Manager: 
// ****************************************************************************
// Inherited Classes)
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
public:
	// 1) Pixel Shader의 추가와 제거.
			CGPTR<PIXELSHADER>	RegisterPixelshader(DWORD p_dwID, PIXELSHADER* p_pPixelShader);
			void				UnregisterPixelshader(PIXELSHADER* p_pPixelShader);

	// 2) 찾기/얻기
			CGPTR<PIXELSHADER>	FindPixelshader(int p_iIndex) const;
			CGPTR<PIXELSHADER>	GetPixelshader(int p_iIndex);
...
private:
	// 1) 
			mutable LOCKABLE
			<std::map<DWORD, CGPTR<PIXELSHADER>>>	m_mapPixelshader;
