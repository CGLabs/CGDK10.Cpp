...
// ----------------------------------------------------------------------------
public:
			void				ResetWorldTransformMatrix()				{	SetWorldTransformMatrix(nullptr);}
	virtual	void				SetWorldTransformMatrix(CMatrix* p_ptmWorld) PURE;
	virtual	CGPTR<CMatrix>		GetWorldTransformMatrix() PURE;
};
