...
//-----------------------------------------------------------------------------
//
// CGAttachable::IModifier
//
// 1. CGAttachable::IModifier는...
...
public:
	...
	virtual	bool			AttachModifier(ICGModifier* p_pModifier) PURE;
	virtual	bool			DetachModifier(ICGModifier* p_pModifier) PURE;
};
