...
//-----------------------------------------------------------------------------
//
// CGAttachable::IRenderer
//
// 1. CGAttachable::IRenderer는...
...
{
public:
	// 1) Renderer Attach/Detach
	virtual	bool			AttachRenderer(ICGRenderer* p_pRenderer) PURE;
	virtual	bool			DetachRenderer(ICGRenderer* p_pRenderer) PURE;
};
