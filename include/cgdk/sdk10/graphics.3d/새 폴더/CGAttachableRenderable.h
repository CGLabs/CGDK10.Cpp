...
//-----------------------------------------------------------------------------
//
// CGAttachable::IRenderable
//
// 1. CGAttachable::IRenderable는...
...
public:
	...
	virtual	bool			AttachRenderable(CGProperty::IRenderable* p_pRenderable) PURE;
	virtual	bool			DetachRenderable(CGProperty::IRenderable* p_pRenderable) PURE;
};
