...
//-----------------------------------------------------------------------------
//
// CGDK::server::web::entity::application
//
//
// ----------------------------------------------------------------------------
class server::web::entity::application :
// inherited classes) 
	virtual public				server::web::entity::Iapplication,
...
public:
			...
			application(const std::string_view _source, server::web::eENTITY_TYPE _entity_type);
