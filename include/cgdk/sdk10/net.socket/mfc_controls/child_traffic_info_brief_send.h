...
// 
//-----------------------------------------------------------------------------
class CGNETSOCKETMFCCONTROL_EXT_CLASS CChild_traffic_info_brief_send : public CChildDialog
{
	DECLARE_DYNAMIC(CChild_traffic_info_brief_send)

// constructor/destructor)
public:
			CChild_traffic_info_brief_send(const statistics::unit_traffic* _pinfo=nullptr, CWnd* pParent=nullptr);   // standard constructor
	virtual ~CChild_traffic_info_brief_send();
...
public:
			...
			void				UpdateTrafficeInfoBriefSend();
