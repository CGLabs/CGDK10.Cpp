...
* @ingroup net::io
*
* @brief datagram용 저수준 i/o를 통해 데이터수신 처리를 정의하는 클래스
*
*/
//-----------------------------------------------------------------------------
class net::io::Ireceivable_datagram :
...
public:
	...
	virtual	intptr_t			process_complete_receivable( uintptr_t _result, std::size_t _transferred, shared_buffer& _buffer, const net::sockaddr& _address) PURE;
};
