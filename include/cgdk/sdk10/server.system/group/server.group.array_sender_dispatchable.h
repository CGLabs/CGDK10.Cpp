...
//-----------------------------------------------------------------------------
/**
 @class		array_sender_dispatchable
*///-----------------------------------------------------------------------------
template <class _TMEMBER, class _TPARAM = sMESSAGE, class _TMEMBER_DATA = int, class _TMEMBERBASE = _TMEMBER>
class group::array_sender_dispatchable : 
	public						array_sender<_TMEMBER, _TPARAM, _TMEMBER_DATA, _TMEMBERBASE>,
	public						net::io::messageable::Nbase
{
public:
	using group_base_t  = array_sender<_TMEMBER, _TPARAM, _TMEMBER_DATA, _TMEMBERBASE>;
...
public:
			array_sender_dispatchable(size_t _max_member = 256) : group_base_t(_max_member) {}
	virtual	~array_sender_dispatchable() noexcept {}
...
void group::array_sender_dispatchable<_TMEMBER, _TPARAM, _TMEMBER_DATA, _TMEMBERBASE>::_process_member_entered(member_t* _pmember, param_t& _param)
{
	// 1) attach member
...
template <class _TMEMBER, class _TPARAM, class _TMEMBER_DATA, class _TMEMBERBASE>
uintptr_t group::array_sender_dispatchable<_TMEMBER, _TPARAM, _TMEMBER_DATA, _TMEMBERBASE>::_process_member_leaving(member_t* _pmember, uintptr_t _param) noexcept
{
	// declare) 
	uintptr_t result = 0;
