...
//-----------------------------------------------------------------------------
/**
 @class		group::array_dispatchable
*///-----------------------------------------------------------------------------
...
public:
			array_dispatchable() : group_base_t() {}
			array_dispatchable(size_t _max_member=256) : group_base_t(_max_member) {}
	virtual	~array_dispatchable() noexcept {}
...
void group::array_dispatchable<_TMEMBER, _TPARAM, _TMEMBER_DATA, _TMEMBERBASE>::_process_member_entered(member_t* _pmember, param_t& _param)
{
...
template <class _TMEMBER, class _TPARAM, class _TMEMBER_DATA, class _TMEMBERBASE>
uintptr_t group::array_dispatchable<_TMEMBER, _TPARAM, _TMEMBER_DATA, _TMEMBERBASE>::_process_member_leaving(member_t* _pmember, uintptr_t _param) noexcept
{
	// declare) 
	uintptr_t result = 0;
