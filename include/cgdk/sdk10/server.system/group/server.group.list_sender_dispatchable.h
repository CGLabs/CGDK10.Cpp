...
//-----------------------------------------------------------------------------
/**
 @class		list_sender_dispatchable
*///-----------------------------------------------------------------------------
template <class _TMEMBER, class _TPARAM = sMESSAGE, class _TMEMBER_DATA = int, class _TMEMBERBASE = _TMEMBER>
class group::list_sender_dispatchable : 
	public						list_sender<_TMEMBER, _TPARAM, _TMEMBER_DATA, _TMEMBERBASE>,
	public						net::io::messageable::Nbase
{
public:
	using group_base_t = list_sender<_TMEMBER, _TPARAM, _TMEMBER_DATA, _TMEMBERBASE>;
...
public:
			list_sender_dispatchable(size_t _max_member=SIZE_MAX) : group_base_t(_max_member) {}
	virtual	~list_sender_dispatchable() {}
...
void group::list_sender_dispatchable<_TMEMBER, _TPARAM, _TMEMBER_DATA, _TMEMBERBASE>::_process_member_entered(member_t* _pmember, param_t& _param)
{
	// 1) register message
...
template <class _TMEMBER, class _TPARAM, class _TMEMBER_DATA, class _TMEMBERBASE>
uintptr_t group::list_sender_dispatchable<_TMEMBER, _TPARAM, _TMEMBER_DATA, _TMEMBERBASE>::_process_member_leaving(member_t* _pmember, uintptr_t _param) noexcept
{
	// declare) 
	uintptr_t result = 0;
