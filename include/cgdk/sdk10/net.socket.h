	...
	namespace net
	{
		...
		namespace io
		{
			...
			namespace sendable
			{
				...
				class Ntcp_sync_gather;
				class Ntcp_sync_gather_buffered;
			...
			namespace sender
			{
				...
				template<class> class Igroup_set;
				template<class> class group_set;
				template<class,class> class Igroup_map;
				template<class, class> class group_map;
			}
		...
		namespace socket
		{
			template <class, class> class tcp_no_gather;
		...
		class concurrent_send_queue;
		class local_send_queue;
	}
...
// 8) sendable
	...
	#include "cgdk/sdk10/net.socket/socket/net.io.sendable.gathering_queue.h"
	#include "cgdk/sdk10/net.socket/socket/net.io.sendable.gathering_queue_bufferd.h"
#endif
...
#include "cgdk/sdk10/net.socket/socket/net.io.sendable.tcp_async_gather_buffered.h"
	...
	#include "cgdk/sdk10/net.socket/socket/net.io.sendable.tcp_async_gather_raw.h"
	#include "cgdk/sdk10/net.socket/socket/net.io.sendable.tcp_async_gather_buffered_raw.h"
#endif
...
#include "cgdk/sdk10/net.socket/socket/net.io.sender.group_set.h"
#include "cgdk/sdk10/net.socket/socket/net.io.sender.group_map.h"
...
// 18) etc
#include "cgdk/sdk10/net.socket/socket/message.remote_request.h"
#include "cgdk/sdk10/net.socket/socket/net.send_queue.h"
...
// 3) socket - tcp
#include "cgdk/sdk10/net.socket/socket/net.socket.tcp_no_gather.h"
...
//----------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------
		...
		// WinSDK 10
				...
				#pragma comment(lib, "cgdk/sdk10/windows/CGDK10.net.socket_Windows10.0_x64_Release.lib")
			#else
				#pragma message("[CGDK10] 'CGDK10.net.socket_Windows10.0_x64_Debug.lib' will be linked")
				#pragma comment(lib, "cgdk/sdk10/windows/CGDK10.net.socket_Windows10.0_x64_Debug.lib")
			#endif
		// Error - No supported
		#else
