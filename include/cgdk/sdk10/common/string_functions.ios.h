...
// - strcpy
inline std::string_view							__strcpy	(char*     _dest, size_t _max, std::string_view    _source)								{ auto count = __select_min(_source.size(), _max - 1);  _source.copy(_dest, count); _dest[count] = 0; return _dest; }
inline std::wstring_view						__strcpy	(wchar_t*  _dest, size_t _max, std::wstring_view   _source)								{ auto count = __select_min(_source.size(), _max - 1);  _source.copy(_dest, count); _dest[count] = 0; return _dest; }
inline std::u16string_view						__strcpy	(char16_t* _dest, size_t _max, std::u16string_view _source)								{ auto count = __select_min(_source.size(), _max - 1);  _source.copy(_dest, count); _dest[count] = 0; return _dest; }
inline std::u32string_view						__strcpy	(char32_t* _dest, size_t _max, std::u32string_view _source)								{ auto count = __select_min(_source.size(), _max - 1);  _source.copy(_dest, count); _dest[count] = 0; return _dest; }
template<size_t I> inline std::string_view		__strcpy	(char     (&_dest)[I], std::string_view    _source)										{ auto count = __select_min(_source.size(), I - 1); _source.copy(_dest, count); _dest[count] = 0; return _dest; }
template<size_t I> inline std::wstring_view		__strcpy	(wchar_t  (&_dest)[I], std::wstring_view   _source)										{ auto count = __select_min(_source.size(), I - 1); _source.copy(_dest, count); _dest[count] = 0; return _dest; }
template<size_t I> inline std::u16string_view	__strcpy	(char16_t (&_dest)[I], std::u16string_view _source)										{ auto count = __select_min(_source.size(), I - 1); _source.copy(_dest, count); _dest[count] = 0; return _dest; }
template<size_t I> inline std::u32string_view	__strcpy	(char32_t (&_dest)[I], std::u32string_view _source)										{ auto count = __select_min(_source.size(), I - 1); _source.copy(_dest, count); _dest[count] = 0; return _dest; }
...
// - u16s
inline char*									encode_string(char*     _dest, std::u16string_view _source, size_t _size = MAX_STRING_LENGTH)
{
