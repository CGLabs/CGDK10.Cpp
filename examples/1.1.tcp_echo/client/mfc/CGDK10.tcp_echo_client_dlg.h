...
protected:
	...
	afx_msg void				OnBnClickedCheckRelayEcho();
	...
	afx_msg void				OnBnClickedCheckDisconnectOnResponse();
...
public:
	// 5) 조작함수.
			...
			afx_msg void OnBnClickedButtonConnect1k();
			afx_msg void OnBnClickedButtonConnect10k();
};
