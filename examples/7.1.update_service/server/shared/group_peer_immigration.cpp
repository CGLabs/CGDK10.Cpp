...
result_code group_socket_immigration::on_member_entering(socket_peer* _pmember, sMESSAGE& /*_msg*/)
{
...
uintptr_t group_socket_immigration::on_member_leaving(socket_peer* _pmember, uintptr_t _param)
{
...
void group_socket_immigration::on_execute()
{
	...
	for_each_member([=](socket_peer* _pmember)
	{
...
{
	// 1) get source
	auto psocket = _msg.get_source<socket_peer>();
