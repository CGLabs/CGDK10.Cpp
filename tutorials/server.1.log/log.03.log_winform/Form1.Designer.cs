namespace tutorial.server.log._03.log_winform.NET.framework
{
	partial class Form1
	{
		...
		{
			this.logview_main = new CGDK.server.system.winform_controls.ListViewLog();
			this.SuspendLayout();
			// 
			// logview_main
			// 
			...
			this.logview_main.log_count = ((ulong)(0ul));
		...
		private CGDK.server.system.winform_controls.ListViewLog logview_main;
	}
}
